...
const deleteAllCmd = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        // Use an empty criteria to delete all documents in the 'Car' collection.
        const deleteResult = yield car_1.Car.deleteMany({});
        // Check the `deletedCount` property in the result to see how many documents were deleted.
